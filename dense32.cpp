...
void CheckAll(){
    ...
    ProjectorV1 projectorSelf = ProjectorV1();
    ...
    std::cout << "V2 Check" << std::endl;

    ProjectorV2 projectorv2 = ProjectorV2();
    int32_t* v2 = run(projectorv2, size_source, source, mask);

    std::cout << "V3 Check" << std::endl;

    ProjectorV3 projectorv3 = ProjectorV3();
    int32_t* v3 = run(projectorv3, size_source, source, mask);

    std::cout << "V4 Check" << std::endl;
